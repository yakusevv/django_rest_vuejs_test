  ...
  <div id="app">
    ...
    <form @submit.prevent="submitForm">
        <div class="form-group row">
            <input type="text" class="form-control col-3 mx-2 mb-2" placeholder="Name" v-model="student.name">
            <input type="text" class="form-control col-3 mx-2 mb-2" placeholder="Course" v-model="student.course">
            <input type="number" min=0 class="form-control col-3 mx-2 mb-2" placeholder="Rating" v-model="student.rating">
            <button class="btn btn-success mx-2 mb-2">Submit</button>
        </div>
    </form>
